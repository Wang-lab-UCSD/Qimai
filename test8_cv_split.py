# adapted from test8_eval_reduce_FP.py
# evaluate on different splits. DPI is trained on different sets of proteins
# make dpi-model-path an argument
# only evaluate on the unseen proteins
# make distinction clear: "we looked and found nothing" vs "we couldn't look because there's nothing to look for"
# also adjust confidence score to make distinction: missing hit (negative); no known motifs (more neutral)
import time
import json
import operator
import os
...
# DeepSEA model ---
DEEPSEA_MODEL_PATH = "/new-stg/home/cong/benchmark/deepsea/best_model_params.pkl"
DEEPSEA_PROTEIN_MAP_PATH = "/new-stg/home/cong/benchmark/deepsea/protein_to_id_map.json"
...
# --- SEI model ---
SEI_MODEL_PATH = "/new-stg/home/cong/DPI/benchmark/sei/best_model_params.pkl"
SEI_PROTEIN_MAP_PATH = "/new-stg/home/cong/benchmark/sei/protein_to_id_map.json"
...
if __name__ == "__main__":
    ...
    try:
        ...
        # --- modification: filter out training proteins from evaluation set ---
