...
parser.add_argument('--task', choices=['chip_690', 'encode3'],
                    default='', type=str, metavar='TASK',
                    help='Task name. Could be chip_690, encode3.')
parser.add_argument('--lr', '--learning-rate', default=1e-4, type=float,
                    metavar='LR', help='initial learning rate', dest='lr')


def get_task(task_name):
    if task_name.lower() == 'chip_690':
        return './dataset/CHIP_690/'
    elif task_name.lower() == 'encode3':
        return './dataset/CHIP_Encode3'
...
def main():
    ...
    df_train = pd.read_pickle(dataFolder + '/train.pkl')
    df_val = pd.read_pickle(dataFolder + '/val.pkl')
    df_test = pd.read_pickle(dataFolder + '/test.pkl')
