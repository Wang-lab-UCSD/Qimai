...
# dataFolder = '/new-stg/home/cong/DPI/dataset/ChIP_690/data_process_v2/embeddings_512bp/'
# input_data = '100_per_exp_max_512bp_train'  
...
# input_data = '1000_per_exp_train'  
# eval_data = '1000_per_exp_test'
# input_data = '100_per_exp_1258exp_RPM_train_norm'  
# eval_data = '100_per_exp_1258exp_RPM_test_norm'
# input_data = '100_per_exp_max_512bp_train_6mer_1_segmentation_10fold'  
# input_data = '100_per_exp_max_512bp_train_6mer_1_segmentation_100fold'  
# input_data = '100_per_exp_max_512bp_train_6mer_1'  
# eval_data = '100_per_exp_max_512bp_test_6mer_2'
# num = 11
...
# combine Encode3 and Encode4 data together
# input_data = '100_per_exp_max_512bp_train_6mer'  
# eval_data = '100_per_exp_max_512bp_test_6mer'
# f1 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode3/**/'+input_data+'_[0-9].pkl', recursive=True)
# f2 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode3/**/'+input_data+'_[0-9][0-9].pkl', recursive=True)
# f3 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode4/**/'+input_data+'_[0-9].pkl', recursive=True)
# files =f1+f2+f3

# deepsea combine Encode3 and Encode4 together
input_data = 'train'
f1 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode3/deepsea/embeddings/'+input_data+'*pkl', recursive=True)
f2 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode4/deepsea/embeddings/'+input_data+'*pkl', recursive=True)
# f2 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode4/deepsea/embeddings/'+input_data+'_6mer_[0-9].pkl', recursive=True)
# f3 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode4/deepsea/embeddings/'+input_data+'_6mer_[0-9][0-9].pkl', recursive=True)
# f4 = glob.glob('/new-stg/home/cong/DPI/dataset/Encode4/deepsea/embeddings/'+input_data+'_6mer_1[0-1][0-9].pkl', recursive=True)
# f5 = ['/new-stg/home/cong/DPI/dataset/Encode4/deepsea/embeddings/'+input_data+'_6mer_120.pkl']
files=f1+f2
