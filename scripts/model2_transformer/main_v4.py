...
eval_data = '100_per_exp_max_512bp_test_6mer_1'
num = 11
...
if __name__ == "__main__":
    ...
    """Output files."""
    file_AUCs = 'output/result/AUCs-v4--lr='+str(lr)+',dropout='+str(dropout)+',hid_dim='+str(hid_dim)+',n_layer='+str(n_layers)+',batch='+str(batch)+',input='+input_data+',max_dna='+str(max_d)+',max_protein='+str(max_p)+'.txt'
    file_model = 'output/model/v4-lr='+str(lr)+',dropout='+str(dropout)+',hid_dim='+str(hid_dim)+',n_layer='+str(n_layers)+',batch='+str(batch)+',input='+input_data+',max_dna='+str(max_d)+',max_protein='+str(max_p)+'.pt'
