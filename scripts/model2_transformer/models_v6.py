...
class Predictor(nn.Module):
    ...
    def forward(self, dna, protein, dna_mask, protein_mask, cross_attn_mask1, cross_attn_mask2):
        ...
        out1 = self.decoder1(enc_trg, enc_src, protein_mask, cross_attn_mask1)
        out2 = self.decoder2(enc_src, enc_trg, dna_mask, cross_attn_mask2)
        out = (out1 + out2)/2
...
#         print(label.shape)
        ...
        score = model(d, p, dna_mask, protein_mask, cross_attn_mask1, cross_attn_mask2)
        m = torch.nn.Sigmoid()
