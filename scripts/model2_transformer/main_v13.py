...
# f3 = glob.glob('/new-stg/home/cong/DPI/dataset/ChIP_690/**/'+input_data+'_[0-9].pkl', recursive=True)
# files =f1+f2+f3
...
#     train_loss, val_loss, val_auc, val_accuracy = [], [], [], []
    ...
    for i in range(0, num_split):
        ...
        print(f"train size: {train_size}", flush=True)
